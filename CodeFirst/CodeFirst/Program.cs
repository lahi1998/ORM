...
namespace ORMConsoleApp
{
    ...
    class Program
    {
        ...
        static void ShowTables(AppDbContext context)
        {
        ...
        static void CreateWorker(AppDbContext context)
        {
        ...
        static void CreateManager(AppDbContext context)
        {
            Console.Write("Enter name: ");
            string name = Console.ReadLine();
            Console.Write("Enter address: ");
        ...
        static void UpdateWorker(AppDbContext context)
        {
        ...
        static void DeleteWorker(AppDbContext context)
        {
